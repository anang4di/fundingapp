...
func (h *userHandler) Login(c *gin.Context) {
	...
	response := helper.APIResponse("Login successfuly", http.StatusOK, "success", formattedUser)
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	...
	response := helper.APIResponse("Upload avatar image successfuly", http.StatusOK, "success", data)
	c.JSON(http.StatusOK, response)
}
...
func (h *userHandler) FetchUser(c *gin.Context) {
	...
	response := helper.APIResponse("Fetch data user successfuly", http.StatusOK, "success", formatter)
